...
dotenv.config();
async function createEvent( eventname,category,service,capacity,street,town,city,authorization) {
    try {
                ...
                await firestore.runTransaction(async (transaction) => {
                    ...
                    if (!doc.exists) {
                        ...
                        transaction.set(eventReference, {
                            events: [{ eventname, category, capacity, street, town, city, service ,createdAt:new Date()}],
                        });
                        ...
                        currentEvents.push({ eventname, category, capacity,street, town, city, service, createdAt: new Date() });
